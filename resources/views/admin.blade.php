...
<form action="/adminn" method="post">
@csrf
  <div class="container"><center>
  <div class="dropdown">
      <select name="email" class="room">
    ...
    <br><br>
    <label for="leavingdate"><h4>Leaving Date </h4></label><br>
    <input type="date" name="leavingdate" required><br>
    <br>
